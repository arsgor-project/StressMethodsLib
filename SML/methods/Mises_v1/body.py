...
def run(data_path):
    ...
    output_data = {'Деталь':detail_list, 'Зона':zone_list, 'Номер КЭ':FE_list, 'Определяющий РС':CritLC_Name_list, 't, [мм]':th_list, 'sigma_vonMises':sVM_list, 'sigma_вр':sVr_list, 'Коэффициент запаса':safetyFactor_list}
